...
# app.py - Parte 6
    ...
    if not st.session_state.solicitacoes:
        ...
        if not dff.empty:
            # Considera custos médios por trecho (ida e volta analisados separadamente)
            # Mapeia custo por trecho de ida
            ...
            # Mapeia custo por trecho de volta
